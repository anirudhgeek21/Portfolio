...
import movieInner from './movie-inner.png';

const MovieComponent = () => {
  return (
    <div className="h-[1000px] bg-black w-full m-auto bg-cover bg-fixed mt-16 pt-2" style={{ backgroundImage: `url(${movieBg})` }}>
      <div className="bg-white rounded-xl w-11/12 md:w-8/12 xl:w-7/12 m-auto px-4 md:px-10 py-3 h-[600px] relative my-20 md:my-44">
        <div className="h-[550px] mt-4">
          <div className="flex w-full md:w-6/12 justify-around text-left">
            <img className="w-28 ring-4 ring-blue-200 h-28 mt-10 ml-2 rounded-xl" src={movieInner} alt="" />
            <div>
          ...
          <div className="w-full md:w-7/12 my-12 ml-0 md:ml-9 text-slate-500">
            <h1>
          ...
          <div className="flex w-full md:w-7/12 justify-around mt-12 md:mt-12 ml-0 md:ml-8">
            <div className="bg-purple-800 text-white px-7 py-3 rounded-full shadow-xl hover:bg-white hover:text-purple-800 duration-700 hover:shadow-black hover:shadow-md">
              <h1><strong>View Project</strong></h1>
            </div>
            ...
            <div className="bg-black text-white px-7 py-3 rounded-full shadow-xl hover:bg-white hover:text-black duration-700 hover:shadow-black hover:shadow-md">
              <h1><strong>Github Link</strong></h1>
            </div>
          </div>
        </div>
